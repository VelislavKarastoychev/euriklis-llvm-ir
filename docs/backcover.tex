...
\begin{tikzpicture}[remember picture,overlay]
    ...
    \node[text width=0.7\paperwidth, align=left, anchor=north] at ([yshift=-3.5cm]current page.north) {
        \begin{center}
        {\Large\bfseries\color{white}About This Handbook\par}
        \end{center}
        ...
        {\large\bfseries\color{accentgold}Main topics:\par}
        ...
        {\large\bfseries\color{white}About the Author\par}
